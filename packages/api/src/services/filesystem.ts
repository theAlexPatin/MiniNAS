 ...
 */
export function resolveVolumePath(volume: VolumeConfig, relativePath: string): string {
...
export async function getFileInfo(volume: VolumeConfig, relativePath: string): Promise<FileEntry> {
...
export async function deleteEntry(volume: VolumeConfig, relativePath: string): Promise<void> {
