		...
		<div className="max-w-2xl mx-auto px-4 py-6">
			...
			<div className="bg-white border border-gray-200 rounded-lg p-5 mb-6 shadow-sm">
				...
				<ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
					...
					<li>
						<strong>macOS:</strong> Finder &rarr; Go &rarr; Connect to Server &rarr; enter the
						server URL
					</li>
					<li>
						<strong>Windows:</strong> File Explorer &rarr; Map Network Drive &rarr; enter the server
						URL
					</li>
					<li>Use your MiniNAS username and the generated token as the password</li>
				</ol>
			...
			{/* Create Token */}
			<div className="bg-white border border-gray-200 rounded-lg p-5 mb-6 shadow-sm">
				<h2 className="text-sm font-semibold text-gray-900 mb-3">Create Access Token</h2>
			...
			<div className="bg-white border border-gray-200 rounded-lg shadow-sm">
				<div className="px-5 py-3 border-b border-gray-100">
					<h2 className="text-sm font-semibold text-gray-900">Active Tokens</h2>
				</div>
				{isLoading ? (
