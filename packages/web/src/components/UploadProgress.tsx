import { AlertCircle, CheckCircle, ChevronDown, ChevronUp, Pause, Play, X } from 'lucide-react'
		...
		<div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
			...
			{!collapsed && (
				<div className="max-h-64 overflow-y-auto px-4 pb-3">
					{uploads.map((item) => (
						<div key={item.id} className="flex items-center gap-3 py-2 border-t border-gray-100">
							{/* Status icon */}
