      ...
      <View style={styles.card}>
        ...
        <View style={styles.createRow}>
          ...
          <Pressable
            ...
            style={[styles.createBtn, (!label.trim() || createMutation.isPending) && { opacity: 0.5 }]}
          >
        ...
        {newToken && (
          <View style={styles.tokenCreated}>
            ...
            <View style={styles.tokenRow}>
              <Text style={styles.tokenValue} selectable>{newToken}</Text>
...
const styles = StyleSheet.create({
  ...
  screenContent: { maxWidth: 640, alignSelf: 'center', width: '100%', padding: 16, paddingBottom: 40 },
  ...
  section: { gap: 16 },
  card: { backgroundColor: '#ffffff', borderWidth: 1, borderColor: Colors.BorderColor.primary, borderRadius: Outlines.borderRadius.lg, padding: 20, ...Outlines.shadow.sm },
  cardTitle: { fontSize: 14, fontWeight: '600', color: Colors.TextColor.primary, marginBottom: 12 },
  createRow: { flexDirection: 'row', gap: 8 },
  input: { flex: 1, backgroundColor: Colors.BackgroundColor.secondary, borderWidth: 1, borderColor: Colors.BorderColor.primary, borderRadius: Outlines.borderRadius.md, paddingHorizontal: 12, paddingVertical: 6, fontSize: 13, color: Colors.TextColor.primary },
  ...
  tokenCreated: { marginTop: 16, backgroundColor: '#ecfdf5', borderWidth: 1, borderColor: '#a7f3d0', borderRadius: Outlines.borderRadius.lg, padding: 16 },
  ...
  tokenValue: { flex: 1, fontFamily: Typography.caption.fontFamily, fontSize: 12, color: '#064e3b', backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#a7f3d0', borderRadius: Outlines.borderRadius.sm, paddingHorizontal: 12, paddingVertical: 6 },
  copyBtn: { padding: 6, borderRadius: Outlines.borderRadius.md },
  dismissText: { fontSize: 11, color: '#047857', marginTop: 8 },
  tokenItem: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: Colors.BorderColor.secondary },
